 ...
 * 
 * <p>An abstract position that serves the same role as integers did for array
 ...
 * the other hand, should never use positions in their interfaces.</p>
 *
 * <p>Note that, strictly speaking, we could also define this interface without
 * any methods in it. However, it's convenient to be able to access the data
 * we care about directly, without going through another abstraction.</p>
 *
